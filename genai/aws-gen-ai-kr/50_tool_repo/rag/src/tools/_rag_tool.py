...
def get_bedrock_client():
    """Get Bedrock client for embeddings and other direct API calls"""
...
def get_embeddings(texts: list, bedrock_client=None):
    """Generate embeddings using Bedrock Runtime API directly"""
    ...
    # Prepare the request body for Cohere Embed
    body = {
