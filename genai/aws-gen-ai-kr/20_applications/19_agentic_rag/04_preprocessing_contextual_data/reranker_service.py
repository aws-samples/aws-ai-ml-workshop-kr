...
class RerankerService:
    def __init__(self, aws_region: str='us-west-2', reranker_model_id: str='amazon.rerank-v1:0', retries: int=10):
        self.aws_region = aws_region
        self.reranker_model_id = reranker_model_id
        self.retries = retries
        self.reranker_client = self._init_reranker_client(aws_region, retries)

    def _init_reranker_client(self, aws_region: str, retries: int):
    ...
    def rank_fusion(self, question, knn_results, bm25_results, hybrid_score_filter=40, final_reranked_results=5, knn_weight=0.6):
