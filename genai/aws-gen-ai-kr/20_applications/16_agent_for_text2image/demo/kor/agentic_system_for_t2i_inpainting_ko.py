...
class GenAIInPainting():
    """A class for editing images."""
    def __init__(self, **kwargs):
        """Initialize the GenAIInPainting with required models and components.
    ...
    def _body_generator(
        ...
        Args:
            ...
            maskImage: Optional mask image for inpainting.
            original_image: Optional original image for inpainting.
        ...
        if taskType == "INPAINTING":
            ...
            if maskImage is not None:
                ...
                raise ValueError("maskImage는 INPAINTING 작업 유형에 필수입니다.")
            
        elif taskType == "OUTPAINTING":
            ...
            raise ValueError("유효하지 않은 taskType입니다. 'TEXT_IMAGE', 'INPAINTING', 'OUTPAINTING' 중 하나여야 합니다.")
    ...
    def _graph_definition(self, **kwargs):
        ...
        def image_generation(state):
            ...
            task_type = state.get("task_type", "INPAINTING")  # 추가: 기본값은 "INPAINTING"
