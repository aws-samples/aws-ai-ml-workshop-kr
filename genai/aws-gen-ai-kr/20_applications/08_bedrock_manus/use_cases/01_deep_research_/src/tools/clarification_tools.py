...
tool_list = [
    ...
    },
    {
        "toolSpec": {
            ...
            "description": "Use this to execute python code for saving the gathered information. If you want to see the output of a value, you should print it out with `print(...)`. This is visible to the user.",
            "inputSchema": {
                "json": {
                    "type": "object",
                    "properties": {
                        "code": {
                            "type": "string",
                            "description": "The python code to execute to save results."
                        }
                    },
                    "required": ["code"]
                }
...
def process_clarification_tool(tool) -> str:
