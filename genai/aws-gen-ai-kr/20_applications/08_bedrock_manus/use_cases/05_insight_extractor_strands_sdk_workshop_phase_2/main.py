...
if __name__ == "__main__":
    ...
    if args.user_query:
        ...
        payload = {
            "user_query": "You will create a sales performance report for Moon Market. Please analyze it from sales and marketing perspectives, generate charts, extract insights, and create a PDF file. The analysis target is the './data/Dat-fresh-food-claude.csv' file. Use english only",
            "session-id": "insight-extractor-5"
        }
        # payload = {
        ...
        #     "session-id": "insight-extractor-3"
        # }
