...
def main():
    ...
    #print ("/opt/ml/input/data/train/dataset/||", os.listdir("/opt/ml/input/data/train/dataset/"))
    #print ("/opt/ml/input/data/train/dataset/translated/merged/||", os.listdir("/opt/ml/input/data/train/dataset/translated/merged/"))
