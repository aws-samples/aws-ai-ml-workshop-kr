...
| ------------ | ------------- | 
**Seoul** (ap-northeast-2) | [![Launch SageMaker Notebook with CloudFormation](images/deploy-to-aws.png)](https://console.aws.amazon.com/cloudformation/home?region=ap-northeast-2#/stacks/new?stackName=sagemaker-notebook&templateURL=https://aws-korea-tech-blog-public.s3.ap-northeast-2.amazonaws.com/aws-ai-ml-workshop-kr/yaml/MLOps-CF.yaml)  
**Virginia** (us-east-1) | [![Launch SageMaker Notebook with CloudFormation](images/deploy-to-aws.png)](https://console.aws.amazon.com/cloudformation/home?region=us-east-1#/stacks/new?stackName=sagemaker-notebook&templateURL=https://aws-korea-tech-blog-public.s3.ap-northeast-2.amazonaws.com/aws-ai-ml-workshop-kr/yaml/MLOps-CF.yaml)  
