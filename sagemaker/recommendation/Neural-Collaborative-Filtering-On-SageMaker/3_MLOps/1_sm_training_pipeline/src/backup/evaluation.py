...
def eval_process(args):
    logger.info("#############################################")
    logger.info(f"args.output_path: {args.output_path}")
    ...
    # Traverse all files
    logger.info(f"****** All folder and files under {args.base_dir} ****** ")
    for file in os.walk(args.base_dir):
        logger.info(f"{file}")
    logger.info(f"************************************************* ")     
    
    with tarfile.open(args.output_path) as tar:
        respone = tar.extractall(path=args.output_evaluation_dir)
        logger.info(f"tar response: \n{respone}")
        
            
    ## metrics.json    
    logger.info(f"evaluation file is saved at \n: {args.output_evaluation_dir}")                    

    logger.info(f"****** After extracting tar file, under {args.base_dir} ****** ")
    for file in os.walk(args.base_dir):
        logger.info(f"{file}")
...
if __name__ == "__main__":
    ...
    parser.add_argument('--output_path', type=str, default= "/opt/ml/processing/output/output.tar.gz")
