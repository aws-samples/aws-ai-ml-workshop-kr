...
It contains about 40 million play records from a total 20043 users. The virtual map where users played game is as follows. The '''diff -Red Zone''' is the area where normal users can not go into.
